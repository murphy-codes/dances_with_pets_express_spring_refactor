...
public class SurrenderApplicationSeeder {
  public void seed(PetTypeRepository petTypeRepository, SurrenderApplicationRepository surrenderApplicationRepository) {
    if(surrenderApplicationRepository.count() == 0) {
